...
# neuron combo
green = "c24914"  # neuron
light_green = "fbbedf"  # fill

# network combo
yellow = "ffdcb8"  # neuron
red = "ffc1b6"  # edge

# other beauties
yellow_orange = "cdfffc"
dark_red = "e9b0df"
brown = "fad586"  # nice edge
dark_brown = "120078"
lavender = "#bebada"
violet = "#bc80bd"
blue = "#80b1d3"
...
class NeuralNetwork(Scene):
    ...
    def title(self):
        title = Tex("Neural Networks")
        title.scale(3)
        title.shift(3*UP)
        mini = Tex("Visualized")
        mini.scale(2)
        mini.next_to(title, DOWN)
        mini.set_color(YELLOW)
        group = VGroup(title, mini)
